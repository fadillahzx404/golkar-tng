            ...
            <div class="relative overflow-x-auto shadow-lg borde bg-white border-gray-200 sm:rounded-lg p-5">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="pb-4">
                        ...
                        <form action="{{ route('import.users') }}" class="flex space-x-3 p-2" method="POST" enctype="multipart/form-data">
                            @csrf
                ...
                columns: [ // mengambil & menampilkan kolom sesuai tabel database
                    ...
                    },
                    {
                        ...
                        render: function (data, type, meta) {
                            ...
                            var editHtml = '<a class="bg-yellow-200 hover:bg-yellow-500 p-3 rounded-md hover:text-white" href="'+editUrl+'"  ><i class="fa-solid fa-edit"></i></a>'
                            var deleteHtml = '<form action="'+deleteUrl+'" class="bg-red-200 hover:bg-red-500 p-3 rounded-md hover:text-white " method="POST"> @csrf @method('DELETE') <button type="submit"><i class="fa-solid fa-trash"></i> </button> </form> '

                            return '<div class="flex space-x-2"> '+ editHtml + deleteHtml+' </div>'
                        }
