        ...
        <section class="section lg:pt-8 py-8">
            <div class="relative overflow-x-auto shadow-lg border rounded-lg bg-white  border-gray-200  p-5">
                <div class="title-table grid ">
                    ...
                    @endif
                    <form action="{{ route('update-pilgub', ['id' => $data->Id]) }}" method="POST"
                        ...
                        <label class="form-control w-full">
                            ...
                            <select
                                ...
                                <option selected value="{{ $data->tps }}">{{ $data->tps }}</option>
                            </select>
                        </label>
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="dpt" type="text" value="{{ $data->dpt }}"
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="sah" type="text" value="{{ $data->sah }}"
                                class="input input-bordered focus:border-warning focus:outline-none w-full" />
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="tidak_sah" type="text" value="{{ $data->tidak_sah }}"
                                class="input input-bordered focus:border-warning focus:outline-none w-full" />
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="paslon1" type="text" value="{{ $data->paslon1 }}"
                                class="input input-bordered focus:border-warning focus:outline-none w-full" />
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="paslon2" type="text" value="{{ $data->paslon2 }}"
                                class="input input-bordered focus:border-warning focus:outline-none w-full" />
                            @if ($errors->has('paslon2'))
                                <span class="text-red-600 mt-3">{{ $errors->first('paslon2') }}</span>
                            @endif
                        ...
                        <div class="flex space-x-2 mt-5">
                            <a href="{{ route('dashboard') }}" class="btn btn-sm text-black">Kembali</a>
