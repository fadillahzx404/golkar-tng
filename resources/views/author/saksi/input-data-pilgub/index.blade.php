        ...
        <section class="section lg:pt-8 py-8">
            <div class="relative overflow-x-auto shadow-lg border rounded-lg bg-white  border-gray-200  p-5">
                <div class="title-table grid ">
                    ...
                    @endif
                    <form action="{{ route('save-pilgub') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="dpt" type="text" value="246"
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="sah" type="text" value="246"
                                class="input input-bordered focus:border-warning focus:outline-none w-full" />
                        ...
                        <label class="form-control w-full">
                            ...
                            <input name="tidak_sah" type="text" value="246"
                                class="input input-bordered focus:border-warning focus:outline-none w-full" />
                        ...
                        <div class="flex items-center mt-5">
                            <button class="btn bg-warning hover:bg-warning" type="submit">
                                Simpan
                            </button>
                        </div>
                    </form>
