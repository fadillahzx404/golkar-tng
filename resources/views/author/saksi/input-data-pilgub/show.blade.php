...
@section('page-content')
    <div class="containercontainer  pt-12 lg:mt-8 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <p class="text-3xl font-bold underline underline-offset-8">Data Saksi {{ $data->name }}</p>
                    ...
                    <div class="flex justify-between">
                        <div class="grid w-full">
                            <div class="flex justify-between place-items-center">
                                ...
                                <div class="badge bg-accent p-3">{{ Str::upper($data->status) }}</div>
                            </div>
                    ...
                    <div class="place-self-center">
                        ...
                        <dialog id="my_modal_3" class="modal">
                            <div class="modal-box w-11/12 max-w-5xl">
                                ...
                                <img src="{{ asset("$data->dokumen") }}" class=" border-2 rounded-xl" alt="">
                            </div>
                        </dialog>
                    </div>
                </div>
