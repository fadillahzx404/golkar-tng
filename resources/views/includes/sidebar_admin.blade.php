<ul class="min-h-full space-y-2">
    ...
    <li><a href="{{ route('code-vouchers.index') }}"
            class="hover:font-semibold hover:bg-green-200 transition duration-300 hover:scale-90 mx-2 {{ request()->is('admin/code-vouchers*') ? 'bg-accent text-white  font-semibold' : 'text-gray-400' }}"><i
                class="fa-solid fa-tags"></i>Code Voucher</a>
    </li>
